...
/// DriverData : DriverData Information about the storage driver used to store the container's and image's filesystem.
...
impl DriverData {
    ...
    pub fn new(data: std::collections::HashMap<String, String>, name: String) -> DriverData {
