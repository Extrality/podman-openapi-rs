...
pub struct InspectContainerConfig {
    ...
    #[serde(
        rename = "HealthcheckMaxLogCount",
        skip_serializing_if = "Option::is_none"
    )]
    pub healthcheck_max_log_count: Option<i32>,
    /// HealthMaxLogSize is the maximum length in characters of stored HealthCheck log (\"0\" value means an infinite log length)
    #[serde(
        rename = "HealthcheckMaxLogSize",
        skip_serializing_if = "Option::is_none"
    )]
    pub healthcheck_max_log_size: Option<i32>,
    ...
    #[serde(rename = "StartupHealthCheck", skip_serializing_if = "Option::is_none")]
    pub startup_health_check: Option<Box<models::StartupHealthCheck>>,
...
impl InspectContainerConfig {
    ...
    pub fn new() -> InspectContainerConfig {
        InspectContainerConfig {
            ...
            healthcheck: None,
            healthcheck_max_log_count: None,
            healthcheck_max_log_size: None,
