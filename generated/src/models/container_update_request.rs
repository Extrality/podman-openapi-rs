...
/// ContainerUpdateRequest : Container update
...
pub struct ContainerUpdateRequest {
    ...
    /// Hard limit for kernel TCP buffer memory (in bytes).  Deprecated: This field is deprecated and will be removed in the next release. Starting with 6.12, the kernel has deprecated kernel memory tcp accounting for cgroups v1.
