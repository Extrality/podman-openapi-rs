...
pub struct ImageInspect {
    ...
    pub config: Option<Box<models::DockerOciImageConfig>>,
    ...
    pub descriptor: Option<Box<models::Descriptor>>,
    /// DockerVersion is the version of Docker that was used to build the image.  Depending on how the image was created, this field may be empty.  Deprecated: this field is deprecated, and will be removed in the next release.
    ...
    pub manifests: Option<Vec<models::ManifestSummary>>,
    ...
    /// Parent is the ID of the parent image.  Depending on how the image was created, this field may be empty and is only set for images that were built/created locally. This field is empty if the image was pulled from an image registry.  Deprecated: this field is deprecated, and will be removed in the next release.
