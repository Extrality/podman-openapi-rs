...
pub enum NetworkCreateSuccess {
    Status201(models::NetworkCreate201Response),
    UnknownValue(serde_json::Value),
}
...
pub async fn network_connect(
    ...
    name: &str,
    create: Option<models::ConnectOptions>,
...
pub async fn network_create(
    configuration: &configuration::Configuration,
    create: Option<models::CreateRequest>,
