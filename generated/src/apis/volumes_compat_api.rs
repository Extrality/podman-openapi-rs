...
pub enum VolumeCreateSuccess {
    Status201(models::VolumeInspect200Response),
...
pub enum VolumeInspectSuccess {
    Status200(models::VolumeInspect200Response),
    UnknownValue(serde_json::Value),
}
...
pub enum VolumeListSuccess {
    Status200(models::VolumeList200Response),
    UnknownValue(serde_json::Value),
}
...
pub enum VolumePruneSuccess {
    Status200(models::VolumePrune200Response),
    UnknownValue(serde_json::Value),
}
...
pub async fn volume_create(
    ...
    create: Option<models::VolumeCreateBody>,
