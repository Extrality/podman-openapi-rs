...
pub enum ContainerHealthcheckLibpodSuccess {
    Status200(models::HealthCheckResults),
    UnknownValue(serde_json::Value),
}
...
pub enum ContainerInspectLibpodSuccess {
    Status200(models::InspectContainerData),
    UnknownValue(serde_json::Value),
}
...
pub enum ContainerPruneLibpodSuccess {
    Status200(Vec<models::ContainersPruneReportLibpod>),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`container_update_libpod`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ContainerUpdateLibpodSuccess {
...
pub enum ContainersStatsAllLibpodSuccess {
    Status200(models::ContainerStats),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`kube_apply_libpod`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KubeApplyLibpodSuccess {
    Status200(std::path::PathBuf),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`container_update_libpod`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ContainerUpdateLibpodError {
    Status400(models::ErrorModel),
    Status404(models::ErrorModel),
    Status500(models::ErrorModel),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`kube_apply_libpod`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum KubeApplyLibpodError {
    Status500(models::ErrorModel),
    UnknownValue(serde_json::Value),
}
...
) -> Result<ResponseContent<ContainerCheckpointLibpodSuccess>, Error<ContainerCheckpointLibpodError>>
{
    ...
    let p_query_ignore_volumes = ignore_volumes;
    let p_query_pre_checkpoint = pre_checkpoint;
    let p_query_with_previous = with_previous;
    let p_query_file_locks = file_locks;
    ...
    if let Some(ref param_value) = p_query_ignore_volumes {
        req_builder = req_builder.query(&[("ignoreVolumes", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_pre_checkpoint {
        req_builder = req_builder.query(&[("preCheckpoint", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_with_previous {
        req_builder = req_builder.query(&[("withPrevious", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_file_locks {
        req_builder = req_builder.query(&[("fileLocks", &param_value.to_string())]);
    }
...
pub async fn container_restore_libpod(
    ...
    let p_query_keep = keep;
    let p_query_tcp_established = tcp_established;
    let p_query_tcp_close = tcp_close;
    ...
    if let Some(ref param_value) = p_query_tcp_close {
        req_builder = req_builder.query(&[("tcpClose", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_query_ps_args {
        req_builder = match "csv" {
            "multi" => req_builder.query(
                &param_value
                    .iter()
                    .map(|p| ("ps_args".to_owned(), p.to_string()))
...
pub async fn container_update_libpod(
    configuration: &configuration::Configuration,
    name: &str,
    restart_policy: Option<&str>,
    restart_retries: Option<i32>,
    config: Option<models::UpdateEntities>,
) -> Result<ResponseContent<ContainerUpdateLibpodSuccess>, Error<ContainerUpdateLibpodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_restart_policy = restart_policy;
    let p_query_restart_retries = restart_retries;
    ...
    if let Some(ref param_value) = p_query_restart_policy {
        req_builder = req_builder.query(&[("restartPolicy", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_restart_retries {
        req_builder = req_builder.query(&[("restartRetries", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ContainerUpdateLibpodSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
        ...
        let content = resp.text().await?;
        let entity: Option<ContainerUpdateLibpodError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn generate_kube_libpod(
    ...
    let p_query_replicas = replicas;
    let p_query_no_trunc = no_trunc;
    let p_query_podman_only = podman_only;
    ...
    if let Some(ref param_value) = p_query_replicas {
        req_builder = req_builder.query(&[("replicas", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_no_trunc {
        req_builder = req_builder.query(&[("noTrunc", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_podman_only {
        req_builder = req_builder.query(&[("podmanOnly", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn generate_systemd_libpod(
    ...
    let p_query_additional_env_variables = additional_env_variables;
    ...
    if let Some(ref param_value) = p_query_additional_env_variables {
        req_builder = match "csv" {
            "multi" => req_builder.query(
                &param_value
                    .iter()
                    .map(|p| ("additionalEnvVariables".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => req_builder.query(&[(
...
pub async fn kube_apply_libpod(
    configuration: &configuration::Configuration,
    ...
    file: Option<&str>,
    request: Option<&str>,
) -> Result<reqwest::Response, Error<KubeApplyLibpodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ca_cert_file = ca_cert_file;
    let p_query_kube_config = kube_config;
    let p_query_namespace = namespace;
    let p_query_service = service;
    let p_query_file = file;
    let p_body_request = request;

    let uri_str = format!("{}/libpod/kube/apply", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);

    if let Some(ref param_value) = p_query_ca_cert_file {
        req_builder = req_builder.query(&[("caCertFile", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_kube_config {
        req_builder = req_builder.query(&[("kubeConfig", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_namespace {
        req_builder = req_builder.query(&[("namespace", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KubeApplyLibpodError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn play_kube_libpod(
    ...
    let p_query_log_options = log_options;
    let p_query_network = network;
    let p_query_no_hosts = no_hosts;
    let p_query_no_trunc = no_trunc;
    let p_query_publish_ports = publish_ports;
    let p_query_publish_all_ports = publish_all_ports;
    let p_query_replace = replace;
    let p_query_service_container = service_container;
    let p_query_start = start;
    let p_query_static_ips = static_ips;
    let p_query_static_macs = static_macs;
    let p_query_tls_verify = tls_verify;
    let p_query_userns = userns;
    ...
    if let Some(ref param_value) = p_query_log_options {
        req_builder = match "csv" {
            "multi" => req_builder.query(
                &param_value
                    .iter()
                    .map(|p| ("logOptions".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => req_builder.query(&[(
                "logOptions",
    ...
    if let Some(ref param_value) = p_query_no_hosts {
        req_builder = req_builder.query(&[("noHosts", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_no_trunc {
        req_builder = req_builder.query(&[("noTrunc", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_publish_ports {
        req_builder = match "csv" {
            "multi" => req_builder.query(
                &param_value
                    .iter()
                    .map(|p| ("publishPorts".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => req_builder.query(&[(
                "publishPorts",
    ...
    if let Some(ref param_value) = p_query_publish_all_ports {
        req_builder = req_builder.query(&[("publishAllPorts", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_replace {
        req_builder = req_builder.query(&[("replace", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_service_container {
        req_builder = req_builder.query(&[("serviceContainer", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_query_userns {
        req_builder = req_builder.query(&[("userns", &param_value.to_string())]);
    }
