# Rust API client for podman-openapi
...
Put the package under your project folder in a directory named `podman-openapi` and add the following to `Cargo.toml` under `[dependencies]`:

```
podman-openapi = { path = "./podman-openapi" }
```
...
------------ | ------------- | ------------- | -------------
*ArtifactsApi* | [**artifact_add_libpod**](docs/ArtifactsApi.md#artifact_add_libpod) | **POST** /libpod/artifacts/add | Add a file as an artifact
*ArtifactsApi* | [**artifact_delete_all_libpod**](docs/ArtifactsApi.md#artifact_delete_all_libpod) | **DELETE** /libpod/artifacts/remove | Remove one or more artifacts
*ArtifactsApi* | [**artifact_delete_libpod**](docs/ArtifactsApi.md#artifact_delete_libpod) | **DELETE** /libpod/artifacts/{name} | Remove an artifact
*ArtifactsApi* | [**artifact_extract_libpod**](docs/ArtifactsApi.md#artifact_extract_libpod) | **GET** /libpod/artifacts/{name}/extract | Extract an artifacts contents
*ArtifactsApi* | [**artifact_inspect_libpod**](docs/ArtifactsApi.md#artifact_inspect_libpod) | **GET** /libpod/artifacts/{name}/json | Inspect an artifact
*ArtifactsApi* | [**artifact_list_libpod**](docs/ArtifactsApi.md#artifact_list_libpod) | **GET** /libpod/artifacts/json | List artifacts
*ArtifactsApi* | [**artifact_pull_libpod**](docs/ArtifactsApi.md#artifact_pull_libpod) | **POST** /libpod/artifacts/pull | Pull an artifact
*ArtifactsApi* | [**artifact_push_libpod**](docs/ArtifactsApi.md#artifact_push_libpod) | **POST** /libpod/artifacts/{name}/push | Push an artifact
...
*ContainersApi* | [**container_update_libpod**](docs/ContainersApi.md#container_update_libpod) | **POST** /libpod/containers/{name}/update | Updates the configuration of an existing container, allowing changes to resource limits and healthchecks
...
*ImagesApi* | [**image_build_libpod**](docs/ImagesApi.md#image_build_libpod) | **POST** /libpod/build | Build image
...
*ImagesApi* | [**local_build_libpod**](docs/ImagesApi.md#local_build_libpod) | **POST** /libpod/local/build | Create image from local build context
*ImagesApi* | [**local_images_libpod**](docs/ImagesApi.md#local_images_libpod) | **POST** /libpod/local/images/load | Load image from local path
*ImagesCompatApi* | [**image_build**](docs/ImagesCompatApi.md#image_build) | **POST** /build | Build image
...
*QuadletsApi* | [**quadlet_list_libpod**](docs/QuadletsApi.md#quadlet_list_libpod) | **GET** /libpod/quadlets/json | List quadlets
...
*SystemApi* | [**system_check_libpod**](docs/SystemApi.md#system_check_libpod) | **POST** /libpod/system/check | Performs consistency checks on storage, optionally removing items which fail checks
...
*VolumesApi* | [**volume_export_libpod**](docs/VolumesApi.md#volume_export_libpod) | **GET** /libpod/volumes/{name}/export | Export a volume
*VolumesApi* | [**volume_import_libpod**](docs/VolumesApi.md#volume_import_libpod) | **POST** /libpod/volumes/{name}/import | Populate a volume by importing provided tar
...
## Documentation For Models
 ...
 - [ArtifactAddReport](docs/ArtifactAddReport.md)
 - [ArtifactInspectReport](docs/ArtifactInspectReport.md)
 - [ArtifactListReport](docs/ArtifactListReport.md)
 - [ArtifactPullReport](docs/ArtifactPullReport.md)
 - [ArtifactPushReport](docs/ArtifactPushReport.md)
 - [ArtifactRemoveReport](docs/ArtifactRemoveReport.md)
 ...
 - [DockerOciImageConfig](docs/DockerOciImageConfig.md)
 ...
 - [ListQuadlet](docs/ListQuadlet.md)
