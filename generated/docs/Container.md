...
**image_manifest_descriptor** | Option<[**models::Descriptor**](Descriptor.md)> |  | [optional]
**labels** | Option<**std::collections::HashMap<String, String>**> |  | [optional]
**mounts** | Option<[**Vec<models::MountPoint>**](MountPoint.md)> |  | [optional]
**name** | Option<**String**> |  | [optional]
**names** | Option<**Vec<String>**> |  | [optional]
**network_settings** | Option<[**models::NetworkSettingsSummary**](NetworkSettingsSummary.md)> |  | [optional]
