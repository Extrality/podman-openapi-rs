...
**exposed_ports** | Option<[**std::collections::HashMap<String, serde_json::Value>**](serde_json::Value.md)> | ExposedPorts includes ports the container has exposed. | [optional]
**health_log_destination** | Option<**String**> | HealthLogDestination defines the destination where the log is stored | [optional]
**healthcheck** | Option<[**models::Schema2HealthConfig**](Schema2HealthConfig.md)> |  | [optional]
**healthcheck_max_log_count** | Option<**i32**> | HealthMaxLogCount is maximum number of attempts in the HealthCheck log file. ('0' value means an infinite number of attempts in the log file) | [optional]
**healthcheck_max_log_size** | Option<**i32**> | HealthMaxLogSize is the maximum length in characters of stored HealthCheck log (\"0\" value means an infinite log length) | [optional]
...
**startup_health_check** | Option<[**models::StartupHealthCheck**](StartupHealthCheck.md)> |  | [optional]
