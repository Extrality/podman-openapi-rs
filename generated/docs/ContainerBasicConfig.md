...
**hostusers** | Option<**Vec<String>**> | HostUses is a list of host usernames or UIDs to add to the container etc/passwd file | [optional]
...
**init_container_type** | Option<**String**> | InitContainerType describes if this container is an init container and if so, what type: always or once | [optional]
...
**log_configuration** | Option<[**models::LogConfig**](LogConfig.md)> |  | [optional]
...
**namespace** | Option<**String**> | Namespace is the libpod namespace the container will be placed in. Optional. | [optional]
...
**raw_image_name** | Option<**String**> | RawImageName is the user-specified and unprocessed input referring to a local or a remote image. | [optional]
**remove** | Option<**bool**> | Remove indicates if the container should be removed once it has been started and exits | [optional]
...
**sdnotify_mode** | Option<**String**> | Determine how to handle the NOTIFY_SOCKET - do we participate or pass it through \"container\" - let the OCI runtime deal with it, advertise conmon's MAINPID \"conmon-only\" - advertise conmon's MAINPID, send READY when started, don't pass to OCI \"ignore\" - unset NOTIFY_SOCKET | [optional]
...
**stdin** | Option<**bool**> | Stdin is whether the container will keep its STDIN open. | [optional]
...
**timeout** | Option<**i32**> | Timeout is a maximum time in seconds the container will run before main process is sent SIGKILL. If 0 is used, signal will not be sent. Container can run indefinitely Optional. | [optional]
