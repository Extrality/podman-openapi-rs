...
**index** | Option<**String**> | Index is the image index (e.g., \"docker.io\" or \"quay.io\") | [optional]
**name** | Option<**String**> | Name is the canonical name of the image (e.g., \"docker.io/library/alpine\"). | [optional]
