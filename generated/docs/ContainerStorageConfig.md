...
**devices_from** | Option<**Vec<String>**> | DevicesFrom is a way to ensure your container inherits device specific information from another container | [optional]
...
**init** | Option<**bool**> | Init specifies that an init binary will be mounted into the container, and will be used as PID1. | [optional]
...
**rootfs_overlay** | Option<**bool**> | RootfsOverlay tells if rootfs is actually an overlay on top of base path | [optional]
...
**volatile** | Option<**bool**> | Volatile specifies whether the container storage can be optimized at the cost of not syncing all the dirty files in memory. | [optional]
