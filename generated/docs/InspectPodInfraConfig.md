...
**networks** | Option<**Vec<String>**> | Networks is a list of CNI networks the pod will join. | [optional]
...
**static_ip** | Option<**Vec<i32>**> | Note that in this documentation, referring to an IP address as an IPv4 address or an IPv6 address is a semantic property of the address, not just the length of the byte slice: a 16-byte slice can still be an IPv4 address. | [optional]
